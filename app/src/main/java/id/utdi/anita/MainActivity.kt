...
fun MovieCard() {
    ...
    val movies = listOf(
        Movie(R.drawable.gambar1, "Informasi tambahan Film 1", "Deskripsi Film 1"),
        Movie(R.drawable.gambar2, "Informasi tambahan Film 2", "Deskripsi Film 2"),
        Movie(R.drawable.gambar3, "Informasi tambahan Film 3", "Deskripsi Film 3"),
